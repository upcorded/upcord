      ...
      <div className="flex min-h-screen">
        ...
        <div className="hidden lg:flex flex-1 items-center justify-center p-8 bg-gradient-to-br from-zinc-100 to-zinc-200">
          <div className="max-w-md">
            ...
            <div className="text-[32px] leading-tight bg-gradient-to-r from-black to-zinc-500 bg-clip-text text-transparent">
              Respond across channels, align your team, and turn every support conversation into actionable product insights.
            </div>
            </blockquote>
          </div>
        </div>
